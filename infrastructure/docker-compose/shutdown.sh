...
curl --location --request DELETE 'localhost:8083/connectors/customer-order-connector'
curl --location --request DELETE 'localhost:8083/connectors/order-customer-connector'
