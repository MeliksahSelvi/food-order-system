...
public class Value extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Value(java.lang.String id, java.lang.String saga_id, java.lang.String created_at, java.lang.String processed_at, java.lang.String type, java.lang.String payload, java.lang.String outbox_status, java.lang.Integer version) {
    this.id = id;
   ...
   */
  public static debezium.customer.customer_outbox.Value.Builder newBuilder() {
    return new debezium.customer.customer_outbox.Value.Builder();
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static debezium.customer.customer_outbox.Value.Builder newBuilder(debezium.customer.customer_outbox.Value.Builder other) {
    if (other == null) {
      return new debezium.customer.customer_outbox.Value.Builder();
    } else {
      return new debezium.customer.customer_outbox.Value.Builder(other);
    }
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static debezium.customer.customer_outbox.Value.Builder newBuilder(debezium.customer.customer_outbox.Value other) {
    if (other == null) {
      return new debezium.customer.customer_outbox.Value.Builder();
    } else {
      return new debezium.customer.customer_outbox.Value.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Value>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(debezium.customer.customer_outbox.Value.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(debezium.customer.customer_outbox.Value other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.customer.customer_outbox.Value.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.customer.customer_outbox.Value.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.customer.customer_outbox.Value.Builder setSagaId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.customer.customer_outbox.Value.Builder clearSagaId() {
      saga_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.customer.customer_outbox.Value.Builder setCreatedAt(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.customer.customer_outbox.Value.Builder clearCreatedAt() {
      created_at = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.customer.customer_outbox.Value.Builder setProcessedAt(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.customer.customer_outbox.Value.Builder clearProcessedAt() {
      processed_at = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.customer.customer_outbox.Value.Builder setType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.customer.customer_outbox.Value.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.customer.customer_outbox.Value.Builder setPayload(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.customer.customer_outbox.Value.Builder clearPayload() {
      payload = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.customer.customer_outbox.Value.Builder setOutboxStatus(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.customer.customer_outbox.Value.Builder clearOutboxStatus() {
      outbox_status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.customer.customer_outbox.Value.Builder setVersion(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.customer.customer_outbox.Value.Builder clearVersion() {
