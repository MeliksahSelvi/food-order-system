...
/*
 * Restaurant üzerinde approval işlemi yapıldığında oluşan sonucu dinleyen input portu.
 * Implementation'u (primary adapter) yine application-service'de olacak.Domain event listener'lar application service katmanında olur.
