...
import com.food.order.system.domain.event.payload.OrderApprovalEventProduct;
...
public class OrderDataMapper {
    ...
    private List<OrderItem> orderItemsToOrderItemEntities(List<com.food.order.system.order.service.domain.dto.create.OrderItem> items) {
