package com.food.order.system.order.service.security.filter;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.food.order.system.order.service.common.rest.ErrorDTO;
import com.food.order.system.order.service.exception.OrderDomainException;
import com.food.order.system.order.service.security.credentials.JwtUserDetails;
import com.food.order.system.order.service.security.util.JwtTokenUtil;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private JwtUserDetails getJwtUserDetailsFromToken(String token) {
        ...
        try {
            ...
            throw new OrderDomainException("Could not read JwtUserDetails object!", e);
        }
    }
    ...
    private void returnErrorResponse(HttpServletResponse response) {
        ...
        try {
            ...
            throw new OrderDomainException("Could not create ErrorDTO json!", e);
        } catch (IOException e) {
